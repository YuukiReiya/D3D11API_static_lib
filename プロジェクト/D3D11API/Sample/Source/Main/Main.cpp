...
//	g_pTex->Load("Resource/Texture/yukina.jpg", { 648,960 });
	//g_pTex->Load("Resource/Texture/Smoke.png", { 256,256 }); 
	g_pTex->Load("Resource/Texture/Smoke.png", { 800,600 });
	g_pTex1->Load("Resource/Texture/red.png", { 800,600 });
	...
	hr = g_pSprite1->Initialize();
	if (FAILED(hr)) { ErrorLog(""); }

	//g_pSprite->SetPos({ -0.2f,-0.2f,1 });

	//g_pSprite->SetAlpha(1.0f);
	//g_pSprite->SetStencilMask(0x000000ff);
	//g_pSprite1->SetStencilMask(0xffff00ff);
